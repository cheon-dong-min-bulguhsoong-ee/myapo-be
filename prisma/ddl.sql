...
COMMENT ON COLUMN tosalpee.users.status        IS '계정 상태 (ACTIVE | SUSPENDED 등). 기본 ACTIVE.';
...
COMMENT ON COLUMN tosalpee.user_wallets.status        IS '지갑 상태 (ACTIVE | SUSPENDED 등).';
