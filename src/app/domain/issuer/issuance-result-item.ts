...
import { IssuanceResultStatus } from './issuance-result-status.enum';
...
export class IssuanceResultItem {
  ...
  static skipped(category: MyDataCategory, reason: string): IssuanceResultItem {
    return new IssuanceResultItem(
      category,
  ...
  static failed(category: MyDataCategory, reason: string): IssuanceResultItem {
    return new IssuanceResultItem(
      category,
