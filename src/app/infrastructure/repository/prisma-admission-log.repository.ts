...
import { CreateAdmissionLogCommand } from '../../domain/gateway/repository/command/create-admission-log.command';
import { PrismaService } from '../prisma/prisma.service';

@Injectable()
export class PrismaAdmissionLogRepository extends AdmissionLogRepository {
