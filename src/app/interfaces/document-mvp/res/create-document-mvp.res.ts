...
export class CreateDocumentMvpRes {
  ...
  @ApiProperty({
    ...
    description:
      "초기 상태. Mock 흐름에서 stage 1·2 가 자동 DONE 이라 곧장 AWAITING_USER_APPROVAL.",
  ...
  @ApiProperty({
    ...
    description:
      "신청 직후 current_stage. Mock 흐름에서 stage 3 (TRANSLATOR_DOC_RECEIVED) 부터 시작.",
    example: DocumentMvpStage.TRANSLATOR_DOC_RECEIVED,
  })
