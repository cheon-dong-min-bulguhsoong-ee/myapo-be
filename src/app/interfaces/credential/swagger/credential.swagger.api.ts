  ...
  withBearer(
    applyDecorators(
      ...
      ApiParam({
        ...
        required: true,
        description:
          "credential_issue_requests.current_stage 값 (USER_DOC_REQUESTED | AUTHORITY_DOC_ISSUED | TRANSLATOR_DOC_RECEIVED | TRANSLATOR_DOC_NOTARIZED | APOSTILLE_DOC_ISSUED | INSTITUTION_DOC_SUBMIT)",
      }),
