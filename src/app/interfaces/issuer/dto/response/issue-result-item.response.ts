...
import { IssuanceResultItem } from '../../../../domain/issuer/result/issuance-result-item';
...
export class IssueResultItemResponse {
  ...
  static from(item: IssuanceResultItem): IssueResultItemResponse {
    return new IssueResultItemResponse(
      item.category,
      item.status,
      item.txHash,
      item.resultCode,
