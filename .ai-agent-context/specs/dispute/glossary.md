...
| **Process Suspension** | `SUSPENSION` | The automatic pausing of an issuance request's progress when a dispute is opened. | "The issuance pipeline stops at 'DOCUMENT_ARRIVED' while the dispute is being reviewed." |
